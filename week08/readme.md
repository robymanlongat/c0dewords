...
We learnt so much this lesson about some different ways text and just individual letters can be presented through code. We were also introduced to the commands < words.push() >, < words.display() >, < words.wiggle() > and the *classes* function. At first I was a little confused with understanding this but once we got to see it being used on the code, it became much easier to get. 
